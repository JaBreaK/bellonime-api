...
class OtakudesuParser extends OtakudesuParserExtra_1.default {
    ...
    parseAnimeEpisode(episodeId) {
        return this.scrape({
            ...
            if (!lruCache_1.cache.get(nonceCacheKey)) {
                const nonce = await (0, dataFetcher_1.belloFetch)(`${this.baseUrl}/wp-admin/admin-ajax.php`, this.baseUrl, {
                    method: "POST",
                    responseType: "json",
    ...
    async parseServerUrl(serverId) {
        ...
        const getUrlData = async (nonce) => {
            return await (0, dataFetcher_1.belloFetch)(`${this.baseUrl}/wp-admin/admin-ajax.php`, this.baseUrl, {
                method: "POST",
                responseType: "json",
                data: new URLSearchParams({
                    id: serverIdArr[0],
